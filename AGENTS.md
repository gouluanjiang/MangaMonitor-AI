...
- On 2026-09-12 the user removed the low-computer-load constraint for the JM download performance follow-up. Use the pinned upstream's normal 20-image lifecycle window and parallel CPU image processing instead of the earlier two-request cap. This does not authorize duplicate local/CI test execution or change download/file authority. See `docs/JM_UPSTREAM_PERFORMANCE_2026-09-12.md`.
